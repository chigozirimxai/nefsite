...
if (isset($_POST['login'])) {
	...
	// IF INPUT NOT EMPTY
		...
		$php= "SELECT * FROM `ceologin` WHERE(`username`='$username' and `password`='$password')";
...
<body style="margin: 0px;padding: 0px;text-decoration: none;" class="login_body">
		...
		<div class="container-fluid">
			<div class="row">
				...
				<p><a href="nefregister.php" style="float: right;background-color: darkgoldenrod;padding: 0.7vw;height: 4vw;text-align: center;"><i>register here!</i></a></p>
